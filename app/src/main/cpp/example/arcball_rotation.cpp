#include "arcball_rotation.h"

void ArcballRotation::start() {
    // use program
    program.use();
...
void ArcballRotation::update(const float deltaTime) {
    // clear screen
    clearScreenAll();
...
void ArcballRotation::arcballRotation() {
...
glm::vec3 ArcballRotation::arcballVector() const {
    // compute vector
    glm::vec3 vector(
